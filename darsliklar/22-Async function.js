...
async function maslahatBering(a) {
    if (typeof a !== 'number') throw new Error ("insert a number");
        ...
        //=============  async functionalda togridan togri setTimeout ishlaaydi
...
function maslahatBering(a, callback) {
    ...
    else if(a > 30 && a <= 40) callback(null,list1[2]);
    else if(a > 40 && a <= 50) callback(null,list1[3]);
    else if(a > 50 && a <= 60) callback(null,list1[4]);
    else {
        setInterval(function () {
            callback(null, list1[4]);
        }, 1000)
      }
    }
